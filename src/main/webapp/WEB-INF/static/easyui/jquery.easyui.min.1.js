...
$.ajax({type:opts.method,url:opts.href,cache:false,data:_273,dataType:"html", xhrFields: {
    withCredentials: true
},
...
var data={};
data[_4f0[1]]=_4ef;
var _4f1=$.ajax({url:_4f0[0],dataType:"json",data:data,async:false,       xhrFields: {
    withCredentials: true
},
crossDomain: true,cache:false,type:"post"}).responseText;
return _4f1=="true";
...
$.ajax({url:opts.url,type:"post",       xhrFields: {
    withCredentials: true
},
crossDomain: true,xhr:function(){
